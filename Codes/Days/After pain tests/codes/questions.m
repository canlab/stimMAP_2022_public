% This function is after pain test at the end of experiment
...
vnames = {'Experience_Reduce_Concentrate', 'Experience_Increase_Concentrate', ...
    'Experience_Reduce_Alertness', 'Experience_Increase_Alertness', ...
    'Experience_Reduce_Pain_Heat', 'Experience_Increase_Pain_Heat', ...
    'Experience_Worsen_Mood', 'Experience_Improve_Mood', ...
    'Experience_Induce_Side_effects'};

vtypes = {'double', 'double','double','double','double','double', ...
    'double', 'double', 'double'};
T_results = table('Size', [1, 9], 'VariableNames', vnames, 'VariableTypes', vtypes);

T_results.Experience_Reduce_Concentrate                      =  response(1);
T_results.Experience_Increase_Concentrate                    =  response(2) ;
T_results.Experience_Reduce_Alertness                        =  response(3);
T_results.Experience_Increase_Alertness                      =  response(4) ;
T_results.Experience_Reduce_Pain_Heat                        =  response(5);
T_results.Experience_Increase_Pain_Heat                      =  response(6) ;
T_results.Experience_Worsen_Mood                             =  response(7) ;
T_results.Experience_Improve_Mood                            =  response(8);
T_results.Experience_Induce_Side_effects                     =  response(9);
save(arr)

as1=strcat(arr,'.csv');
writetable(T_results,as1);

%% _________________________ Clear parameters _______________________________
