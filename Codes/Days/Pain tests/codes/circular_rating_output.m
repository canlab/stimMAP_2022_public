function [trajectory, display_onset, RT, response_onset, biopac_display_onset, angle] = circular_rating_output(duration, p, scale_tex, channel,rating_type, channel_type)
